...
/**
 * list_len - determine size of link list
...
/**
 * list_to_strings - return strings of the list->str
...
/**
 * print_list - print elements that list_t linked list
...
/**
 * node_starts_with - return node string that start with prefix
