...
/**
 * hsh - main shell loop
 * @info: the parameter that returns struct
 ...
 * @info: parameter that returns struct
...
/**
 * find_cmd - find a command PATH
 * @info: parameter to return struct
 * Return: void
 */
...
/**
 * fork_cmd - fork that exec thread to cmd
 * @info: parameter that return struct
 * Return: void
 */
